...
SWIFT_CLASS("_TtC6socket11AppDelegate")
...
SWIFT_CLASS("_TtC6socket23TCPClientViewController")
@interface TCPClientViewController : UIViewController
@property (nonatomic, weak) IBOutlet UITextField * __null_unspecified serverIP;
@property (nonatomic, weak) IBOutlet UITextField * __null_unspecified serverPort;
...
- (void)viewDidLoad;
- (IBAction)conn:(UIButton * __nonnull)sender;
- (IBAction)send:(UIButton * __nonnull)sender;
...
@interface TCPClientViewController (SWIFT_EXTENSION(socket)) <UITextFieldDelegate>
...
@interface TCPServerViewController (SWIFT_EXTENSION(socket)) <UITextFieldDelegate>
- (BOOL)textFieldShouldReturn:(UITextField * __nonnull)textField;
@end


@interface TCPServerViewController (SWIFT_EXTENSION(socket))
@end
